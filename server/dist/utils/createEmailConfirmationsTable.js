...
exports.createEmailConfirmationsTable = void 0;
const supabase_1 = require("../config/supabase");
const createEmailConfirmationsTable = async () => {
    try {
        const { error } = await supabase_1.supabaseAdmin.rpc('exec_sql', {
            sql: `
...
exports.createEmailConfirmationsTable = createEmailConfirmationsTable;
if (require.main === module) {
    (0, exports.createEmailConfirmationsTable)()
        .then((success) => {
        if (success) {
...
//# sourceMappingURL=createEmailConfirmationsTable.js.map